...
function Navigation(state, books) {
...
function Header(state) {
  return "\n    <header>\n        <img src=\"https://freepagenumbers.files.wordpress.com/2012/03/cropped-header.jpg\" alt=\"Bookstore\" height=\"333\">\n        <h1> DD's Bookstore <h1>\n    </header>";
}
...
function Book(book) {
  var returnText = "\n    <div class=\"book\">\n        <h2>".concat(book.title, "</h4>\n        <h3>By ").concat(book.author, "</h3>\n        <ul>");

  for (var i = 0; i < book.sellingPoints.length; i++) {
    returnText += "<li>".concat(book.sellingPoints[i], "</li>");
  }
...
function Content(state, books) {
  var returnText = "\n    <div class=\"bookContainer\">";

  for (var i = 0; i < books.length; i++) {
    returnText += (0, _Book.default)(books[i]);
  }
...
;
},{"./Book.js":"components/Book.js"}],"components/Footer.js":[function(require,module,exports) {
"use strict";
...
var _Content = _interopRequireDefault(require("./components/Content.js"));
...
var book = null; //JSON.parse(localStorage.getItem('books'));
...
function render(state, book) {
  ...
  document.getElementById("buttonAddBook").addEventListener("click", function () {
    ...
    var sellingPoint1 = document.getElementById('sellingPoint1').value;
    var sellingPoint2 = document.getElementById('sellingPoint2').value;
    var sellingPoint3 = document.getElementById('sellintPoint3').value;
    var newBook = {
      id: book.length,
      title: title,
      author: author,
...
;
render(home, book);
},{"./components/Navigation.js":"components/Navigation.js","./components/Header.js":"components/Header.js","./components/Content.js":"components/Content.js","./components/Footer.js":"components/Footer.js"}],"../../AppData/Roaming/npm-cache/_npx/2296/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/npm-cache/_npx/2296/node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/Bookstore.e31bb0bc.js.map